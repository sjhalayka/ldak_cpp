...
extern "C"
{
    ...
    extern void dgemv_(char* trans, int* m, int* n, const double* alpha, const double* a, int* lda, const double* x, int* incx, const double* beta, double* y, int* incy);
    extern void ssymm_(char* transa, char* transb, int* m, int* n, float* k, float* alpha, const int* a, float* lda, const int* b, float* ldb, float* beta, int* c);
    extern void ssymv_(char* trans, int* m, float* n, float* alpha, int* a, float* lda ,int* incx, float* beta, float* y, int* incy);
    ...
    extern void sgemv_(char* trans, int* m, int* n, const float* alpha, const float* a, int* lda, const float* x, int* incx, const float* beta, float* y, int* incy);
    extern double ddot_(int* n, double* dx, int* incx, double* dy, int* invy);
    extern void sspmv_(char* upto, int* n, float* alpha, float* ap, float* x, int* incx, float* beta, float* y, int* incy);
}
