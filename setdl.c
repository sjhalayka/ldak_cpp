...
data_length=get_effects(effects, bivar, bivar3, keeppreds_use, num_phenos, num_causals, probsfile, causalsfile, effectsfile, num_preds_use, keeppreds, num_preds, allpreds, predorder);
}
